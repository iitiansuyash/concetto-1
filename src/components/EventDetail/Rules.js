        ...
        <Helmet>
          ...
          <meta
            ...
            content={`Organized by ${event.is_club
              ...
              } of IIT (ISM) Dhanbad, during Concetto 2019. ${!event.rules ? event.description : "Rules: " + event.rules
              } `}
          />
          <meta
            name="keywords"
            content={`${event.name} concetto rules, ${event.name} rules , ${event.name
              } 2019 rules, ${event.is_club ? event.club : event.dept
